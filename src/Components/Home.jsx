            ...
            <Row className="row">
              {sortedCloths.map((cloth) => (
                <Col key={cloth.id} xs={12} sm={6} md={4} lg={3}>
                  <CardHolder cloth={cloth} handleViewMore={handleViewMore} />
                </Col>
              ))}
            </Row>
          ...
          <div className="col-md-2 info-section ">
            <div className="contact-info">
              <p>
                <h3>Email:</h3>
                <a
                  href="mailto: levickwears@gmail.com"
                  style={{ color: "goldenrod", textDecoration: "none" }}
                >
                  {" "}
                  levickwears@gmail.com
                </a>
              </p>
              <p>
                {" "}
